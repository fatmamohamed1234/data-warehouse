...
![Data Pipeline Architecture](DW_Mart_Build/image.png)
...
- **Files:** [`01_create_tables_dw.sql`](DW_Mart_Build/01_create_tables_dw.sql), [`02_load_schema_dw.sql`](DW_Mart_Build/02_load_schema_dw.sql)
...
- **File:** [`03_create_flat_mart.sql`](DW_Mart_Build/03_create_flat_mart.sql)
...
- **File:** [`04_create_skills_mart.sql`](DW_Mart_Build/04_create_skills_mart.sql)
...
- **Files:** [`05_create_priority_mart.sql`](DW_Mart_Build/05_create_priority_mart.sql) (initial build), [`06_update_priority_mart.sql`](DW_Mart_Build/06_update_priority_mart.sql) (incremental update)
...
3. Move into the `DW_Mart_Build` folder and run the master build script:
